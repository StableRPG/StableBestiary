...
import me.jeremiah.bestiary.BestiaryPlugin;
...
import me.jeremiah.bestiary.gui.BestiaryGUI;
...
public class Link {
  ...
  public List<String> getLore(BestiaryPlayer bPlayer) {
    ...
    switch (type) {
      case ENTRY -> {
        LevelController lc = BestiaryPlugin.getPlatform().getEntry(target).getLevelController();
      ...
      case CATEGORY -> {
        BestiaryCategory category = BestiaryPlugin.getPlatform().getCategory(target);
